...
Dokumen ini adalah rancangan arsitektur dan langkah-langkah implementasi untuk merombak total sistem *Quality Control* (QC) berbasis AI. Sistem ini akan menggabungkan keandalan **Laravel** sebagai *core server*, interaktivitas **React.js** via **Inertia.js** untuk antarmuka pengguna, dan **Python** sebagai *Inference Engine* AI.
